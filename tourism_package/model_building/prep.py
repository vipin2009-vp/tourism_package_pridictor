...
api = HfApi(token=os.getenv("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"))
DATASET_PATH = "hf://datasets/Vipin0287/tourism-package-repo/tourism.csv"
...
for file_path in files:
    api.upload_file(
        ...
        repo_id="Vipin0287/tourism-package-repo",
        repo_type="dataset",
    )
